...
{
    private readonly SemesterProcessor _processor;

    public SemestersController(SemesterProcessor processor)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Save([FromBody] SemesterCommand command)
    {
