...
public static class HtmlOutput
{
    ...
    private static string GetTableHeader(Room room)
    {
        ...
        sb.Append("</tr>\n");
        sb.Append("<tr>\n");
        sb.Append("<th style='border: .1em solid black; padding: .25em'>Lab: ").Append(room.IsLab ? "Yes" : "No").Append("</th>\n");
        sb.Append("<th style='border: .1em solid black; padding: .25em'>Seats: ").Append(room.Capacity).Append("</th>\n");
        sb.Append("</tr>\n");
        return sb.ToString();
    }
